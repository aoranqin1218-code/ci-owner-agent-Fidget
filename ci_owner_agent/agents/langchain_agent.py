...
from ci_owner_agent.agents.initial_input import build_initial_input_payload
from ci_owner_agent.agents.notice_parser import parse_notice as parse_notice_output
...
from ci_owner_agent.services.metrics import (
    ...
    llm_invoke_with_metrics,
)
from ci_owner_agent.services.scorer import (
    downgrade_to_no_high_confidence,
    validate_notice,
)
...
class LangChainResponsibilityAgent:
    ...
    def _parse_notice(self, raw: str) -> CiResponsibilityNotice | None:
        return parse_notice_output(raw)
